    ...
    <body>
        ...
        <div class="container border p-4" style="max-width: 400px; border-radius: 10px;"> 
            ...
            <div class="text-center"> 
                <a href="atv-02.html" class="btn btn-secondary mt-2 col-sm-5" style="background-color: lightcoral; border-color: black; color: black;">Voltar</a>
                <a href="/Lista-03/Atv-03/atv-03.html" class="btn btn-secondary mt-2 col-sm-5" style="background-color: lightskyblue; border-color: black; color: black;">Próximo</a>
            </div> 
        </div>
    </body>
</html>